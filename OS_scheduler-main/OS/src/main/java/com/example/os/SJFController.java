...
public class SJFController implements Initializable {
    ...
    private String name; //used in printing condition
    ...
    public void addSJFProcess(ActionEvent mouseEvent) throws IOException {
    ...
    public void doPreemSJF(ActionEvent mouseEvent) throws IOException, InterruptedException {
...
//load output scene
    ...
    public void doNonPreemSJF (ActionEvent mouseEvent) throws IOException {
        //load output scene
        FXMLLoader loader = new FXMLLoader(getClass().getResource("InstantOutputView.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
    ...
    public void doNonPreemSJFLive(ActionEvent mouseEvent) throws IOException{
    ...
    public void doPreemSJFLive(ActionEvent mouseEvent) throws IOException{
